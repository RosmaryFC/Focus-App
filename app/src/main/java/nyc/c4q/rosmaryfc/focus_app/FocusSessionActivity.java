...
//    }
    ...
    public void saveOnClick (View view){
        ...
        editor.putString("fs_name", nameET.getText().toString()).apply();
        editor.putString("fs_start_time", startTimeET.getText().toString()).apply();
        editor.putString("fs_end_time", endTimeET.getText().toString()).apply();
        editor.putString("fs_date", dateET.getText().toString()).apply();
    }
